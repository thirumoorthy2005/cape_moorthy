...
VOLUME /tmp
COPY --from=buildenv /root/.m2/repository/com/capeelectric/LV-Safety-Verification/0.0.1-SNAPSHOT/LV-Safety-Verification-0.0.1-SNAPSHOT.jar lv-safety-verification.jar
EXPOSE 8086
